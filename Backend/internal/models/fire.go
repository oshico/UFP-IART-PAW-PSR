...
type CauseGroup struct {
	...
	Description string `gorm:"column:description;size:255; not null; uniqueIndex"`
}
...
type AlertSource struct {
	ID          uint   `gorm:"primaryKey; autoIncrement; not null"`
	Description string `gorm:"column:decription; size:255; not null; uniqueIndex"`
}
...
type Fire struct {
	...
	Local    string `gorm:"column:local;size:255; not null"`
